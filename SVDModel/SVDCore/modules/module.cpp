...
std::shared_ptr<Module> Module::moduleFactory(std::string module_name, std::string module_type)
{
    ...
    Module *m = nullptr;
    switch (idx) {
    case 0: m = new MatrixModule(module_name, module_type); break;
    case 1: m = new FireModule(module_name, module_type); break;
    case 2: m = new WindModule(module_name, module_type); break;
    case 3: m = new BarkBeetleModule(module_name, module_type); break;
    case 4: m = new SimpleManagementModule(module_name, module_type); break;
    case 5: m = new AutoManagementModule(module_name, module_type); break;
