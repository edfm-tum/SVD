---
title: "Configuring the landscape"
---

The simulated landscape is a (large) grid of `cells` with a cell size of 100m. Additional spatial layers
specify properties of the environment (site and climate conditions). A cell has also a [state](states.qmd) and a
...
subsequently used in [expressions](variables.qmd). The column name in the `landscape.file` is used as the variable name.
