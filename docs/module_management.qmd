...
The file containing a transition matrix (see [matrix module](module_matrix.qmd)) for post management states (see above).
...
The module can provide tabular and gridded [output](outputs.qmd#Management).
